...
shinyUI(fluidPage(
  ...
  dashboardPage(
    ...
    dashboardBody(
      ...
      actionBttn("results_bttn","Results", size='xs'), 
      actionBttn("diet_bttn","Children's Nutrition", size='xs'), 
      actionBttn("vic_bttn","Victorian Analysis", size='xs'),
      actionBttn("pa_bttn","Physical Activity", size='xs'),
      hr(),
      tabItems(
        ...
        tabItem("pa", h3("60 minutes per day = Unlimited Possibilities"), tags$br(),
                fluidRow(
                  column(width=6, offset=3,
                         fluidRow(infoBox(h2("Health Wise"), width=NULL, icon=icon("stethoscope"), fill=TRUE, color="blue",
                         ...
                         fluidRow(infoBox(h2("Academic"), width=NULL, icon=icon("graduation-cap"), fill=TRUE, color="olive",
